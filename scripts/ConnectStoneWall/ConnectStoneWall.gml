/// @description ConnectStoneWall(SurroundingCells, Coordinate, Connector) Builds connector object based on
///	the referenced surroundingcell and coordinate of the stone wall.
...
if(surroundingcells[# coordinate[0], coordinate[1]] == oStoneWall){
